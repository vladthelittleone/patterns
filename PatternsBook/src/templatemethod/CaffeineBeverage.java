...
public abstract class CaffeineBeverage {
    ...
    /**
     * Фишка паттерна:
     * Метод описывает алгоритм. Методы, одинаковые для разных реализаций,
     * не abstract. Методы, не одинаковые, abstract. Сам метод алгоритма final,
     * так как он указывает последовательность выполнения алгоритма и не может
     * быть изменен. Так же можно указывать final методы.
     */
